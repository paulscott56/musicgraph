 ...
 * assigned in the CISAC database to each Interested Party in musical rights
 * management.
 * 
 * In October 2001, the IPI database replaced the CAE database.
 * 
 * IPI numbers are attached to ISWC numbers, to allow CISAC to attach
 * information such as author, composer, and arranger to ISWC registered works.
 * IPI numbers can also be used at the websites of other work registration
 * organizations, such as BMI to locate works in their databases.
 * 
 * @author paul
 * 
 */
