 ...
 * Latin is the most common script, and usually the correct choice. 
 * It is used for all Western European languages, and many others. 
 * It is also the most common script used for transliterations.
 * 
 * Arabic العربية
